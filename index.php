...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 6720;
        $headers['auth']['clientCompany'] = "lXsrLzx0rGrDqqdGXHUN";
        $headers['auth']['clientSecret'] = "NjcyMGxYc3JMengwckdyRHFxZEdYSFVOY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
